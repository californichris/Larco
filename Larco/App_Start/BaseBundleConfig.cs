...
namespace EPE.Common
{
    public static class BaseBundleConfig
    {
        ...
        public static readonly string JQueryCSSVirtualPath = StylesPath + "cupertino/jquery_css";
        ...
        public static void RegisterScriptBundles(BundleCollection bundles)
        {
            ...
            var styleBundle = new StyleBundle(JQueryCSSVirtualPath)
                .Include(StylesPath + "cupertino/jquery-ui.css")
                .Include(StylesPath + "cupertino/jquery-horizontal-menu.css")
                .Include(StylesPath + "cupertino/dataTables.jqueryui.css");
